// Link moving down with a magical shield class
//
...
{
    public class LinkSouthMagicalShield : ILinkState
    {
        ...
        public LinkSouthMagicalShield(Link link, int variant = 1)
        {
        ...
        public void UseSlot1(ProjectileSummoner itemHandler, Slot1Item slot1)
        {
            ...
            switch (slot1)
            {
                ...
                case Slot1Item.WoodSword:
                    link.SetState(new LinkSouthMagicalShieldWoodSword(link, variant));
                    break;
                case Slot1Item.WhiteSword:
                    link.SetState(new LinkSouthMagicalShieldWhiteSword(link, variant));
                    break;
                case Slot1Item.MagicalSword:
                    link.SetState(new LinkSouthMagicalShieldMagicalSword(link, variant));
                    break;
                default:
        ...
        public void UseSlot2(ProjectileSummoner itemHandler, Slot2Item slot2)
        {
            ...
            if (itemHandler.UseSlot2Item(slot2, Direction.South))
            {
                ...
                {
                    link.SetState(new LinkSouthMagicalShieldMagicalRod(link, variant));
                }
                else
                {
