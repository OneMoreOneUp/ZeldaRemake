// Link moving to the left with a magical shield class
//
...
{
    public class LinkWestMagicalShield : ILinkState
    {
        ...
        public LinkWestMagicalShield(Link link, int variant = 1)
        {
        ...
        public void UseSlot1(ProjectileSummoner itemHandler, Slot1Item slot1)
        {
            ...
            switch (slot1)
            {
                ...
                case Slot1Item.WoodSword:
                    link.SetState(new LinkWestMagicalShieldWoodSword(link, variant));
                    break;
                case Slot1Item.WhiteSword:
                    link.SetState(new LinkWestMagicalShieldWhiteSword(link, variant));
                    break;
                case Slot1Item.MagicalSword:
                    link.SetState(new LinkWestMagicalShieldMagicalSword(link, variant));
                    break;
                default:
        ...
        public void UseSlot2(ProjectileSummoner itemHandler, Slot2Item slot2)
        {
            ...
            if (itemHandler.UseSlot2Item(slot2, Direction.West))
            {
                ...
                {
                    link.SetState(new LinkWestMagicalShieldMagicalRod(link, variant));
                }
                else
                {
