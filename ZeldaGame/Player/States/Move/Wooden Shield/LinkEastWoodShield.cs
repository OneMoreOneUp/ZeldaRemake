// Link moving to the right with a wooden shield class
//
...
{
    public class LinkEastWoodShield : ILinkState
    {
        ...
        public LinkEastWoodShield(Link link, int variant = 1)
        {
        ...
        public void UseSlot1(ProjectileSummoner itemHandler, Slot1Item slot1)
        {
            ...
            switch (slot1)
            {
                ...
                case Slot1Item.WoodSword:
                    link.SetState(new LinkEastWoodShieldWoodSword(link, variant));
                    break;
                case Slot1Item.WhiteSword:
                    link.SetState(new LinkEastWoodShieldWhiteSword(link, variant));
                    break;
                case Slot1Item.MagicalSword:
                    link.SetState(new LinkEastWoodShieldMagicalSword(link, variant));
                    break;
                default:
        ...
        public void UseSlot2(ProjectileSummoner itemHandler, Slot2Item slot2)
        {
            ...
            if (itemHandler.UseSlot2Item(slot2, Direction.East))
            {
                ...
                {
                    link.SetState(new LinkEastWoodShieldMagicalRod(link, variant));
                }
                else
                {
