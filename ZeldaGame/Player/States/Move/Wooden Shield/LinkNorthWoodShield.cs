// Link moving up with a wooden shield class
//
...
{
    public class LinkNorthWoodShield : ILinkState
    {
        ...
        public LinkNorthWoodShield(Link link, int variant = 1)
        {
        ...
        public void UseSlot1(ProjectileSummoner itemHandler, Slot1Item slot1)
        {
            ...
            switch (slot1)
            {
                ...
                case Slot1Item.WoodSword:
                    link.SetState(new LinkNorthWoodShieldWoodSword(link, variant));
                    break;
                case Slot1Item.WhiteSword:
                    link.SetState(new LinkNorthWoodShieldWhiteSword(link, variant));
                    break;
                case Slot1Item.MagicalSword:
                    link.SetState(new LinkNorthWoodShieldMagicalSword(link, variant));
                    break;
                default:
        ...
        public void UseSlot2(ProjectileSummoner itemHandler, Slot2Item slot2)
        {
            ...
            if (itemHandler.UseSlot2Item(slot2, Direction.North))
            {
                ...
                {
                    link.SetState(new LinkNorthWoodShieldMagicalRod(link, variant));
                }
                else
                {
