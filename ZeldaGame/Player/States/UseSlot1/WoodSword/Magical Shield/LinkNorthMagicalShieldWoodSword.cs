// Link attacking Up with a Wood sword class with magical shield
//
...
{
    public class LinkNorthMagicalShieldWoodSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthMagicalShieldWoodSword(Link link, int variant = 1)
        {
