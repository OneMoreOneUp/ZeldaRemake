// Link attacking Left with a Wood sword class with magical shield
//
...
{
    public class LinkWestMagicalShieldWoodSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestMagicalShieldWoodSword(Link link, int variant = 1)
        {
