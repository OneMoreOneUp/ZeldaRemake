// Link attacking Right with a Wood sword class with wooden shield
//
...
{
    public class LinkEastWoodShieldWoodSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkEastWoodShieldWoodSword(Link link, int variant = 1)
        {
