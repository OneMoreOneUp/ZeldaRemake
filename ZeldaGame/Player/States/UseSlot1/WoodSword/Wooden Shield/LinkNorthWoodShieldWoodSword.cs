// Link attacking Up with a Wood sword class with wooden shield
//
...
{
    public class LinkNorthWoodShieldWoodSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthWoodShieldWoodSword(Link link, int variant = 1)
        {
