// Link attacking Left with a Wood sword class with wooden shield
//
...
{
    public class LinkWestWoodShieldWoodSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestWoodShieldWoodSword(Link link, int variant = 1)
        {
