// Link attacking down with a white sword class with magical shield
//
...
{
    public class LinkSouthMagicalShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthMagicalShieldWhiteSword(Link link, int variant = 1)
        {
