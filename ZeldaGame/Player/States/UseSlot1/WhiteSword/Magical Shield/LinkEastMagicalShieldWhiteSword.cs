// Link attacking Right with a white sword class with magical shield
//
...
{
    public class LinkEastMagicalShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkEastMagicalShieldWhiteSword(Link link, int variant = 1)
        {
