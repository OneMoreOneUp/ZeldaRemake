// Link attacking Left with a white sword class with magical shield
//
...
{
    public class LinkWestMagicalShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestMagicalShieldWhiteSword(Link link, int variant = 1)
        {
