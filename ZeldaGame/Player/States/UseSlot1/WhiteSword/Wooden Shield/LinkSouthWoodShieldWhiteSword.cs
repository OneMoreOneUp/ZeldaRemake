// Link attacking down with a white sword class with wooden shield
//
...
{
    public class LinkSouthWoodShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthWoodShieldWhiteSword(Link link, int variant = 1)
        {
