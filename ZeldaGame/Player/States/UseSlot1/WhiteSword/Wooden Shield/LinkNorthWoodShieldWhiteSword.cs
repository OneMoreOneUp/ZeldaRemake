// Link attacking Up with a white sword class with wooden shield
//
...
{
    public class LinkNorthWoodShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthWoodShieldWhiteSword(Link link, int variant = 1)
        {
