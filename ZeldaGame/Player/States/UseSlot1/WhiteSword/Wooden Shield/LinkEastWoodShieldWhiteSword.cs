// Link attacking Right with a white sword class with wooden shield
//
...
{
    public class LinkEastWoodShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkEastWoodShieldWhiteSword(Link link, int variant = 1)
        {
