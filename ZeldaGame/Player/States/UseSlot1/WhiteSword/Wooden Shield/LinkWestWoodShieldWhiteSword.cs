// Link attacking Left with a white sword class with wooden shield
//
...
{
    public class LinkWestWoodShieldWhiteSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestWoodShieldWhiteSword(Link link, int variant = 1)
        {
