// Link attacking Left with a magical sword class with wooden shield
//
...
{
    public class LinkWestWoodShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestWoodShieldMagicalSword(Link link, int variant = 1)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (animationIndex == 0 && link.UpdateSprite()) link.SetState(new LinkWestWoodShield(link, variant));
        }
