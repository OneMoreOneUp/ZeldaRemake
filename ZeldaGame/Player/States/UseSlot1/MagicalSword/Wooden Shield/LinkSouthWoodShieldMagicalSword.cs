// Link attacking down with a Wood sword class with wooden shield
//
...
{
    public class LinkSouthWoodShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthWoodShieldMagicalSword(Link link, int variant = 1)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (animationIndex == 0 && link.UpdateSprite()) link.SetState(new LinkSouthWoodShield(link, variant));
        }
