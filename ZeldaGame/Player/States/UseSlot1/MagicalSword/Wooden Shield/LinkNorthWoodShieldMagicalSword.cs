// Link attacking Up with a magical sword class with magical shield
//
...
{
    public class LinkNorthWoodShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthWoodShieldMagicalSword(Link link, int variant = 1)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (animationIndex == 0 && link.UpdateSprite()) link.SetState(new LinkNorthWoodShield(link, variant));
        }
