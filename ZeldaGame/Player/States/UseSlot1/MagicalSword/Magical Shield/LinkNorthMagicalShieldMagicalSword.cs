// Link attacking Up with a magical sword class with wooden shield
//
...
{
    public class LinkNorthMagicalShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthMagicalShieldMagicalSword(Link link, int variant = 1)
        {
