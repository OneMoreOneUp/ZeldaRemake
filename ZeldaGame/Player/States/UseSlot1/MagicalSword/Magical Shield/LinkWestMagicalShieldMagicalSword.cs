// Link attacking Right with a magical sword class with magical shield
//
...
{
    public class LinkWestMagicalShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestMagicalShieldMagicalSword(Link link, int variant = 1)
        {
