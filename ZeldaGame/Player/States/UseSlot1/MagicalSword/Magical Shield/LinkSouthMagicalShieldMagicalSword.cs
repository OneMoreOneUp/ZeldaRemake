// Link attacking down with a Wood sword class with magical shield
//
...
{
    public class LinkSouthMagicalShieldMagicalSword : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthMagicalShieldMagicalSword(Link link, int variant = 1)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (animationIndex == 0 && link.UpdateSprite()) link.SetState(new LinkSouthMagicalShield(link, variant));
        }
