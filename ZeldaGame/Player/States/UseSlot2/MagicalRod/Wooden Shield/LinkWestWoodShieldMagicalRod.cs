// Link attacking Left with a Magical Rod class with wooden shield
//
...
{
    public class LinkWestWoodShieldMagicalRod : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkWestWoodShieldMagicalRod(Link link, int variant = 1)
        {
