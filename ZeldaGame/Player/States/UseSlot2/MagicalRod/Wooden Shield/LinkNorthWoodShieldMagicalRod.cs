// Link attacking Up with a Magical Rod class with wooden shield
//
...
{
    public class LinkNorthWoodShieldMagicalRod : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthWoodShieldMagicalRod(Link link, int variant = 1)
        {
