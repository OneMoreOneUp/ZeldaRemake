// Link attacking down with a Magical Rod class with wooden shield
//
...
{
    public class LinkSouthWoodShieldMagicalRod : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthWoodShieldMagicalRod(Link link, int variant = 1)
        {
