// Link attacking Up with a Magical Rod class with magical shield
//
...
{
    public class LinkNorthMagicalShieldMagicalRod : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkNorthMagicalShieldMagicalRod(Link link, int variant = 1)
        {
