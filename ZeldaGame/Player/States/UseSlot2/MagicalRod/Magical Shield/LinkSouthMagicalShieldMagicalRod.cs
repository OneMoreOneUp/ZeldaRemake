// Link attacking down with a Magical Rod class with magical shield
//
...
{
    public class LinkSouthMagicalShieldMagicalRod : ILinkState
    {
        private readonly Link link;
        private int animationIndex;
        private readonly int animationSpeed, variant;
        public LinkSouthMagicalShieldMagicalRod(Link link, int variant = 1)
        {
