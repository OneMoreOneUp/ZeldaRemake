...
{
    public class SecondLifePotion : IItem
    {
        ...
        public SecondLifePotion(Point position, ItemDataManager data, int cost = 0)
        {
        ...
        public void PlayerPickUp(IAdventurePlayer player)
        {
            ...
            if (this.cost <= inventory.GetBalance())
            {
                ...
                inventory.AddItem(Item.SecondLifePotion);
