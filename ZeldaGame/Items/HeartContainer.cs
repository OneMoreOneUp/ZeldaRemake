...
namespace ZeldaGame.Items
{
    class HeartContainer : IItem
    {
        ...
        public HeartContainer(Point position, ItemDataManager data, int cost = 0)
        {
        ...
        {
            //Left empty since Heart Container has not animation or movement();
        }
        ...
        public void PlayerPickUp(IAdventurePlayer player)
        {
            ...
            if (this.cost <= inventory.GetBalance())
            {
                ...
                inventory.SetMaxHealth(inventory.GetMaxHealth() + 2);
