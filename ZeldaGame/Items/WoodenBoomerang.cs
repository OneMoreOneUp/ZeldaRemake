...
namespace ZeldaGame.Items
{
    class WoodenBoomerang : IItem
    {
        ...
        public WoodenBoomerang(Point position, ItemDataManager data, int cost = 0)
        {
        ...
        {
            //Boomerang Item doesn't have animation or movement
        }
        ...
        public void PlayerPickUp(IAdventurePlayer player)
        {
            ...
            if (this.cost <= inventory.GetBalance())
            {
                ...
                inventory.AddItem(Item.WoodenBoomerang);
