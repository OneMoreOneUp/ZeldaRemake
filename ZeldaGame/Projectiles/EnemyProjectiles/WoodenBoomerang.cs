// Enemy boomerang projectile class
...
{
    class WoodenBoomerang : IEnemyProjectile
    {
        ...
        public WoodenBoomerang(Point position, Direction direction, IEnemy owner, EnemyProjectileDataManager data)
        {
