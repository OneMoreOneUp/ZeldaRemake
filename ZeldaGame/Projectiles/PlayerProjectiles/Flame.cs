...
namespace ZeldaGame.PlayerProjectiles
{
    class Flame : IPlayerProjectile
    {
        ...
        public Flame(Direction direction, IAdventurePlayer owner, PlayerProjectileDataManager data)
        {
            ...
            SoundFactory.Instance.GetSound(Sound.Candle).Play();
        }
