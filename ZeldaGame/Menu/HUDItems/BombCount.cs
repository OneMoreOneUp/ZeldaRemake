...
namespace ZeldaGame.HUD.HUDItems
{
    class BombCount : IMenuItem
    {
        ...
        public BombCount(PlayerInventory inventory, Boolean inHUD = true, bool playerTwo = false)
        {
            ...
            List<Point> collection = MenuFactory.Instance.GetPointCollection("BombCount");
        ...
        public void Update()
        {
            if (Count != Inventory.ItemAmount(Item.Bomb))
            {
                Count = Inventory.ItemAmount(Item.Bomb);
