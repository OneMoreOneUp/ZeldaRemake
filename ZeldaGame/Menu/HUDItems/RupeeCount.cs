...
namespace ZeldaGame.HUD.HUDItems
{
    class RupeeCount : IMenuItem
    {
        ...
        public RupeeCount(PlayerInventory inventory, bool inHUD = true, bool playerTwo = false)
        {
            ...
            List<Point> collection = MenuFactory.Instance.GetPointCollection("RupeeCount");
        ...
        public void Update()
        {
            if (Count != Inventory.GetBalance())
            {
                Count = Inventory.GetBalance();
